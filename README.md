...
* Ability to create unlimited promo banners or marketing message
* Ability to display promotions at the home, product, category, cart, checkout, and other pages
* Ability to select one or multiple products to display banner from grid
* Ability to select one ot multiple categories to display banners from multi-select options
* Support 14 predefine, positions to display the promotions at any page
* Ability to display multiple promo banners and bars in an attractive slider
* Ability to restrict promotions display to one store view or a particular customer group;
* Manage all promo and marekting messages in the admin panel
* Support multistore
* Mobile-friendly

<img src="https://www.ulmod.com/media/ulmod/product_content/pbanner-banners-min.png">
